...
function* api_v1_gfkhgkjhgkj_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gfkhgkjhgkj_list, action)
    yield put(actions.api_v1_gfkhgkjhgkj_listSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_gfkhgkjhgkj_listFailed(err))
  }
}
function* api_v1_gfkhgkjhgkj_listWatcher() {
  yield takeEvery(types.API_V1_GFKHGKJHGKJ_LIST, api_v1_gfkhgkjhgkj_listWorker)
}
function* api_v1_gfkhgkjhgkj_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gfkhgkjhgkj_create, action)
    yield put(actions.api_v1_gfkhgkjhgkj_createSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_gfkhgkjhgkj_createFailed(err))
  }
}
function* api_v1_gfkhgkjhgkj_createWatcher() {
  yield takeEvery(
    types.API_V1_GFKHGKJHGKJ_CREATE,
    api_v1_gfkhgkjhgkj_createWorker
  )
}
function* api_v1_gfkhgkjhgkj_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gfkhgkjhgkj_read, action)
    yield put(actions.api_v1_gfkhgkjhgkj_readSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_gfkhgkjhgkj_readFailed(err))
  }
}
function* api_v1_gfkhgkjhgkj_readWatcher() {
  yield takeEvery(types.API_V1_GFKHGKJHGKJ_READ, api_v1_gfkhgkjhgkj_readWorker)
}
function* api_v1_gfkhgkjhgkj_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gfkhgkjhgkj_update, action)
    yield put(actions.api_v1_gfkhgkjhgkj_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_gfkhgkjhgkj_updateFailed(err))
  }
}
function* api_v1_gfkhgkjhgkj_updateWatcher() {
  yield takeEvery(
    types.API_V1_GFKHGKJHGKJ_UPDATE,
    api_v1_gfkhgkjhgkj_updateWorker
  )
}
function* api_v1_gfkhgkjhgkj_partial_updateWorker(action) {
  try {
    const result = yield call(
      apiService.api_v1_gfkhgkjhgkj_partial_update,
      action
    )
    yield put(actions.api_v1_gfkhgkjhgkj_partial_updateSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_gfkhgkjhgkj_partial_updateFailed(err))
  }
}
function* api_v1_gfkhgkjhgkj_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_GFKHGKJHGKJ_PARTIAL_UPDATE,
    api_v1_gfkhgkjhgkj_partial_updateWorker
  )
}
function* api_v1_gfkhgkjhgkj_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gfkhgkjhgkj_delete, action)
    yield put(actions.api_v1_gfkhgkjhgkj_deleteSucceeded(result))
  } catch (err) {
    yield put(actions.api_v1_gfkhgkjhgkj_deleteFailed(err))
  }
}
function* api_v1_gfkhgkjhgkj_deleteWatcher() {
  yield takeEvery(
    types.API_V1_GFKHGKJHGKJ_DELETE,
    api_v1_gfkhgkjhgkj_deleteWorker
  )
}
...
export default function* rootSaga() {
  const sagas = [
    ...
    api_v1_gfkhgkjhgkj_listWatcher,
    api_v1_gfkhgkjhgkj_createWatcher,
    api_v1_gfkhgkjhgkj_readWatcher,
    api_v1_gfkhgkjhgkj_updateWatcher,
    api_v1_gfkhgkjhgkj_partial_updateWatcher,
    api_v1_gfkhgkjhgkj_deleteWatcher,
