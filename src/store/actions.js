...
export const api_v1_gfkhgkjhgkj_list = () => ({
  type: types.API_V1_GFKHGKJHGKJ_LIST
})
export const api_v1_gfkhgkjhgkj_listSucceeded = response => ({
  type: types.API_V1_GFKHGKJHGKJ_LIST_SUCCEEDED,
  response
})
export const api_v1_gfkhgkjhgkj_listFailed = error => ({
  type: types.API_V1_GFKHGKJHGKJ_LIST_FAILED,
  error
})
export const api_v1_gfkhgkjhgkj_create = () => ({
  type: types.API_V1_GFKHGKJHGKJ_CREATE
})
export const api_v1_gfkhgkjhgkj_createSucceeded = response => ({
  type: types.API_V1_GFKHGKJHGKJ_CREATE_SUCCEEDED,
  response
})
export const api_v1_gfkhgkjhgkj_createFailed = error => ({
  type: types.API_V1_GFKHGKJHGKJ_CREATE_FAILED,
  error
})
export const api_v1_gfkhgkjhgkj_read = () => ({
  type: types.API_V1_GFKHGKJHGKJ_READ
})
export const api_v1_gfkhgkjhgkj_readSucceeded = response => ({
  type: types.API_V1_GFKHGKJHGKJ_READ_SUCCEEDED,
  response
})
export const api_v1_gfkhgkjhgkj_readFailed = error => ({
  type: types.API_V1_GFKHGKJHGKJ_READ_FAILED,
  error
})
export const api_v1_gfkhgkjhgkj_update = () => ({
  type: types.API_V1_GFKHGKJHGKJ_UPDATE
})
export const api_v1_gfkhgkjhgkj_updateSucceeded = response => ({
  type: types.API_V1_GFKHGKJHGKJ_UPDATE_SUCCEEDED,
  response
})
export const api_v1_gfkhgkjhgkj_updateFailed = error => ({
  type: types.API_V1_GFKHGKJHGKJ_UPDATE_FAILED,
  error
})
export const api_v1_gfkhgkjhgkj_partial_update = () => ({
  type: types.API_V1_GFKHGKJHGKJ_PARTIAL_UPDATE
})
export const api_v1_gfkhgkjhgkj_partial_updateSucceeded = response => ({
  type: types.API_V1_GFKHGKJHGKJ_PARTIAL_UPDATE_SUCCEEDED,
  response
})
export const api_v1_gfkhgkjhgkj_partial_updateFailed = error => ({
  type: types.API_V1_GFKHGKJHGKJ_PARTIAL_UPDATE_FAILED,
  error
})
export const api_v1_gfkhgkjhgkj_delete = () => ({
  type: types.API_V1_GFKHGKJHGKJ_DELETE
})
export const api_v1_gfkhgkjhgkj_deleteSucceeded = response => ({
  type: types.API_V1_GFKHGKJHGKJ_DELETE_SUCCEEDED,
  response
})
export const api_v1_gfkhgkjhgkj_deleteFailed = error => ({
  type: types.API_V1_GFKHGKJHGKJ_DELETE_FAILED,
  error
})
